...
export function RenomateTeaser() {
  return (
    <section className="bg-indigo-600 text-white py-24 px-6 md:px-12 overflow-hidden relative">
       {/* Background Decoration */}
       <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-indigo-500 rounded-full blur-[100px] opacity-50 pointer-events-none translate-x-1/2 -translate-y-1/2" />
       ...
       <div className="max-w-[1800px] mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
             ...
             <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 md:p-12 rounded-2xl">
               <div className="flex items-start gap-4 mb-8">
                  ...
                  <div className="space-y-4 flex-1">
                     <div className="bg-white/90 p-4 rounded-lg rounded-tl-none text-indigo-900 text-sm font-medium shadow-lg">
                       "I want a coastal bathroom with terrazzo tiles, under $25k."
                     </div>
                     <div className="bg-indigo-800/80 p-4 rounded-lg rounded-tr-none text-white text-sm ml-auto w-fit max-w-[90%] shadow-lg">
          ...
          <div className="order-1 lg:order-2">
             ...
             <p className="text-lg md:text-xl text-indigo-100 max-w-xl leading-relaxed mb-10">
             ...
             <div className="flex flex-col sm:flex-row gap-4">
                <Button href="/renomate" variant="secondary" size="lg" className="bg-white text-indigo-600 hover:bg-white/90 border-transparent">
                  Meet Renomate
                </Button>
