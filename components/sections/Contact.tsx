  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-[var(--color-background)] px-6 md:px-12">
      <div className="max-w-4xl mx-auto">
        ...
        {status === 'success' ? (
          <div className="bg-[#111] text-white p-12 text-center animate-in fade-in duration-500">
            <h3 className="text-2xl font-bold mb-4">Request Received</h3>
            <p className="opacity-80">Thank you for your interest. We will be in touch shortly to discuss your renovation.</p>
            <button 
          ...
          <form onSubmit={handleSubmit} className="space-y-12">
            ...
            <div className="flex justify-center pt-8">
              <button
                ...
                className="bg-[#111] text-white px-12 py-5 text-sm font-bold uppercase tracking-widest hover:bg-black/80 transition-colors disabled:opacity-50 w-full md:w-auto min-w-[300px]"
              >
