    ...
    <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-[var(--color-surface)]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            transform: mounted ? 'scale(1) rotate(0deg)' : 'scale(0.8) rotate(10deg)',
            transition: 'transform 200ms cubic-bezier(0.34, 1.56, 0.64, 1) 0.05s',
          }}
        />
      </div>

      <Container>
        <div className="grid md:grid-cols-12 gap-16 md:gap-20 items-center relative z-10 py-24 md:py-40">
          {/* Text Content - Asymmetric placement */}
          <div
            className="md:col-span-7 lg:col-span-6 px-6 md:px-0"
            style={{
              opacity: mounted ? 1 : 0,
              transform: mounted ? 'translateY(0)' : 'translateY(30px)',
              transition: 'opacity 200ms ease-out 0.1s, transform 200ms ease-out 0.1s',
            }}
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold text-[var(--color-tertiary)] mb-10 md:mb-12 leading-[1.1]">
              Transform
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-[var(--color-on-surface-variant)] mb-12 md:mb-16 leading-loose font-normal" style={{ maxWidth: '42rem' }}>
            ...
            <div
              ...
              style={{
                ...
                transition: 'opacity 200ms ease-out 0.15s, transform 200ms ease-out 0.15s',
              }}
            >
              <Link href="/#contact">
                <Button
          ...
          <div
            className="md:col-span-5 lg:col-span-6 px-6 md:px-0"
            style={{
              opacity: mounted ? 1 : 0,
              transform: mounted ? 'translateX(0)' : 'translateX(50px)',
              transition: 'opacity 200ms ease-out 0.12s, transform 200ms ease-out 0.12s',
            }}
          >
            <div className="relative">
              <div className="bg-white rounded-3xl shadow-2xl border border-[var(--color-tertiary-container)]" style={{ padding: 'clamp(48px, 5vw, 80px)' }}>
                <div className="space-y-12 md:space-y-14">
                  <div className="flex items-baseline gap-5 pb-10 border-b border-[var(--color-tertiary-container)]">
                    <span className="text-6xl md:text-7xl font-bold text-[var(--color-primary)]" style={{ fontFamily: 'var(--font-fraunces), serif', fontVariantNumeric: 'tabular-nums' }}>15+</span>
              ...
              <div
                ...
                style={{
                  ...
                  transition: 'transform 200ms ease-out 0.18s',
                }}
              />
            </div>
          </div>
