      ...
      <main className="bg-background pt-32 pb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
             <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button href="#" variant="primary" size="lg" className="bg-blue-600 border-blue-600 text-white hover:bg-blue-700">
                    Try Renomate Free
                  </Button>
             ...
             <div className="relative aspect-square md:aspect-[4/3] bg-blue-50 rounded-2xl border border-blue-100 p-8 flex flex-col shadow-xl overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-12 bg-white border-b border-blue-100 flex items-center px-4 gap-2">
                ...
                <div className="mt-8 flex-1 space-y-6 font-mono text-sm">
                   <div className="bg-white p-4 rounded-lg shadow-sm w-3/4 animate-[fadeIn_0.5s_ease-out_0.2s_both]">
                     <span className="text-xs text-blue-400 block mb-1">User</span>
                     Estimate a 3x3m bathroom renovation in Mosman with high-end finishes.
                   </div>
                   <div className="bg-blue-600 text-white p-4 rounded-lg shadow-sm w-5/6 ml-auto animate-[fadeIn_0.5s_ease-out_0.8s_both]">
                     <span className="text-xs text-blue-200 block mb-1">Renomate AI</span>
        ...
        <section className="px-6 md:px-12 max-w-[1800px] mx-auto mb-32">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                 <span className="text-blue-600 font-bold tracking-widest uppercase text-xs mb-4 block">Included Tools</span>
        ...
        {/* Lead Capture  */}
        <section className="bg-blue-900 text-white py-24 px-6 md:px-12 text-center">
            ...
            <div className="max-w-md mx-auto flex flex-col gap-4">
              <input 
                ...
                className="w-full px-6 py-4 rounded-none bg-blue-800/50 border border-blue-700 text-white placeholder:text-blue-400 focus:outline-none focus:border-white transition-colors"
              />
              <Button href="#" variant="primary" size="lg" className="w-full bg-white text-blue-900 border-transparent hover:bg-blue-50">
                Get Early Access
              </Button>
            </div>
        </section>
